...
{
    public class ImageSet: IEnumerable<Uri>
    {
        public ImageSet()
        {
        }

        public ImageSet(string s, string m, string l, string xl, string xxl = null)
        {
            Small = new Uri(s);
            Medium = new Uri(m);
            Large = new Uri(l);
        ...
        public static ImageSet ParseJToken(JToken images)
        {
            var c = new ImageSet();
